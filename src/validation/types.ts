...
export interface ValidationCurrentMetrics {
  ...
  activeListingPriceMinUsd?: number | null;
  activeListingPriceMaxUsd?: number | null;
  activeFreeShippingPct?: number | null;
  activePromotedListingsPct?: number | null;
  activeWatcherCoverageCount?: number | null;
  soldPriceMinUsd?: number | null;
  soldPriceMaxUsd?: number | null;
  soldFreeShippingPct?: number | null;
  soldTotalSellers?: number | null;
...
export interface TerapeakValidationSignals {
  ...
  activeListingPriceMinUsd: number | null;
  activeListingPriceMaxUsd: number | null;
  activeAvgShippingUsd: number | null;
  activeFreeShippingPct: number | null;
  activePromotedListingsPct: number | null;
  activeListingsCount: number | null;
  activeAvgWatchersPerListing: number | null;
  activeWatcherCoverageCount: number | null;
  soldAvgPriceUsd: number | null;
  soldMedianPriceUsd: number | null;
  soldPriceMinUsd: number | null;
  soldPriceMaxUsd: number | null;
  soldAvgShippingUsd: number | null;
  soldFreeShippingPct: number | null;
  marketPriceUsd: number | null;
